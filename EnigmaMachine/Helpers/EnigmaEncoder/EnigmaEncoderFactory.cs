...
namespace EnigmaMachine.Helpers.EnigmaEncoder
{
    public static class EnigmaEncoderFactory
    {
        ...
        {
            if (String.IsNullOrEmpty(enigmaEncoderType))
            {
                throw new NullReferenceException("enigmaEncoderType can't be null or empty");
            }

            if (String.IsNullOrEmpty(uwkTypeName))
            {
                throw new NullReferenceException("uwkTypeName can't be null or empty");
            }
            ...
            addRotorsToRotorList(rotorList, rotorNames);
        ...
        private static void addRotorsToRotorList(List<Rotor> rotorList, string[] rotorNames)
        {
